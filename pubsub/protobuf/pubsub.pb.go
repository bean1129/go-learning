...
var file_pubsub_proto_rawDesc = []byte{
	...
	,
}
...
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: protobuf.PubsubService.Publish:input_type -> protobuf.String
	0, // 1: protobuf.PubsubService.SubscribeTopic:input_type -> protobuf.String
	0, // 2: protobuf.PubsubService.Subscribe:input_type -> protobuf.String
	0, // 3: protobuf.PubsubService.Publish:output_type -> protobuf.String
	0, // 4: protobuf.PubsubService.SubscribeTopic:output_type -> protobuf.String
	0, // 5: protobuf.PubsubService.Subscribe:output_type -> protobuf.String
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/protobuf.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) SubscribeTopic(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeTopicClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/protobuf.PubsubService/SubscribeTopic", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[1], "/protobuf.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.PubsubService/Publish",
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.PubsubService",
